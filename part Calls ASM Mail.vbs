Sub VoltasPartsCallsASMMailFormat()
...
vDELCOLs = Array("MODEL", "SRSerialNumber", "LStatus", "Shipment #", "Part Stock", "Part Availability", "Part Status", "BranchAction", "CWHAction", "Final Status", "SR Status", "SR Status with SF Stock", "Responsibility", "Responsibility After SF Stock", "RPM", "Source", "ETA Remark", "SR", "Supplying Plant Name-SIT", "Delivery Date SIT", "SIT Qty", "SUPPLY Plant Name-STO", "PUR DOC NO-STO", "DOCUMENT DATE-STO", "Pending QTY-STO", "XStatus", "INVID", "Ageing Bracket")
With ThisWorkbook
...
'Find Service_Agent_Code # column
    ...
    On Error Resume Next
    xStr_Service_Agent_Code = "FranchiseeCode"
...
'Find CourierN # column
    Dim xRg_CourierN As Range
    Dim xRgUni_CourierN As Range
    Dim xAddress_CourierN As String
    Dim xStr_CourierN As String
    On Error Resume Next
    xStr_CourierN = "Courier Name"
    Set xRg_CourierN = ActiveSheet.UsedRange.Find(xStr_CourierN, , xlValues, xlWhole, , , True)
    If Not xRg_CourierN Is Nothing Then
        xAddress_CourierN = xRg_CourierN.Address
        Do
            Set xRg_CourierN = ActiveSheet.UsedRange.FindNext(xRg_CourierN)
            If xRgUni_CourierN Is Nothing Then
                Set xRgUni_CourierN = xRg_CourierN
            Else
                Set xRgUni_CourierN = Application.Union(xRgUni_CourierN, xRg_CourierN)
            End If
        Loop While (Not xRg_CourierN Is Nothing) And (xRg_CourierN.Address <> xAddress_CourierN)
    End If
    xRgUni_CourierN.EntireColumn.Activate
     With xRgUni_CourierN.EntireColumn
        .ColumnWidth = 10
        .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
        .WrapText = True
        ...
        .MergeCells = False
    End With
'Find CourierN # column END

'Find DocketNo # column
    Dim xRg_DocketNo As Range
    Dim xRgUni_DocketNo As Range
    Dim xAddress_DocketNo As String
    Dim xStr_DocketNo As String
    On Error Resume Next
    xStr_DocketNo = "Docket No"
    Set xRg_DocketNo = ActiveSheet.UsedRange.Find(xStr_DocketNo, , xlValues, xlWhole, , , True)
    If Not xRg_DocketNo Is Nothing Then
        xAddress_DocketNo = xRg_DocketNo.Address
        Do
            Set xRg_DocketNo = ActiveSheet.UsedRange.FindNext(xRg_DocketNo)
            If xRgUni_DocketNo Is Nothing Then
                Set xRgUni_DocketNo = xRg_DocketNo
            Else
                Set xRgUni_DocketNo = Application.Union(xRgUni_DocketNo, xRg_DocketNo)
            End If
        Loop While (Not xRg_DocketNo Is Nothing) And (xRg_DocketNo.Address <> xAddress_DocketNo)
    End If
    xRgUni_DocketNo.EntireColumn.Activate
     With xRgUni_DocketNo.EntireColumn
        .ColumnWidth = 17
        .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
        .WrapText = True
        ...
        .MergeCells = False
    End With
'Find DocketNo # column END

'Find DocketStatus # column
    Dim xRg_DocketStatus As Range
    Dim xRgUni_DocketStatus As Range
    Dim xAddress_DocketStatus As String
    Dim xStr_DocketStatus As String
    On Error Resume Next
    xStr_DocketStatus = "Docket Status"
    Set xRg_DocketStatus = ActiveSheet.UsedRange.Find(xStr_DocketStatus, , xlValues, xlWhole, , , True)
    If Not xRg_DocketStatus Is Nothing Then
        xAddress_DocketStatus = xRg_DocketStatus.Address
        Do
            Set xRg_DocketStatus = ActiveSheet.UsedRange.FindNext(xRg_DocketStatus)
            If xRgUni_DocketStatus Is Nothing Then
                Set xRgUni_DocketStatus = xRg_DocketStatus
            Else
                Set xRgUni_DocketStatus = Application.Union(xRgUni_DocketStatus, xRg_DocketStatus)
            End If
        Loop While (Not xRg_DocketStatus Is Nothing) And (xRg_DocketStatus.Address <> xAddress_DocketStatus)
    End If
    xRgUni_DocketStatus.EntireColumn.Activate
     With xRgUni_DocketStatus.EntireColumn
        .ColumnWidth = 12
        .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
        .WrapText = True
...
'Find  PART2
    Dim xRg_PART2 As Range
    Dim xRgUni_PART2 As Range
    Dim xAddress_PART2 As String
    Dim xStr_PART2 As String
    On Error Resume Next
    xStr_PART2 = "PART#"
    Set xRg_PART2 = ActiveSheet.UsedRange.Find(xStr_PART2, , xlValues, xlWhole, , , True)
    If Not xRg_PART2 Is Nothing Then
        xAddress_PART2 = xRg_PART2.Address
        Do
            Set xRg_PART2 = ActiveSheet.UsedRange.FindNext(xRg_PART2)
            If xRgUni_PART2 Is Nothing Then
                Set xRgUni_PART2 = xRg_PART2
            Else
                Set xRgUni_PART2 = Application.Union(xRgUni_PART2, xRg_PART2)
            End If
        Loop While (Not xRg_PART2 Is Nothing) And (xRg_PART2.Address <> xAddress_PART2)
    End If
    'Application.CutCopyMode = False ' don't want an existing operation to interfere
    xRgUni_PART2.EntireColumn.Activate
     With xRgUni_PART2.EntireColumn
        '.ColumnWidth = 8
        .AutoFit
    .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
...
'Find PART
    Dim xRg_PART As Range
    Dim xRgUni_PART As Range
    Dim xAddress_PART As String
    Dim xStr_PART As String
    On Error Resume Next
    xStr_PART = "PART"
    Set xRg_PART = ActiveSheet.UsedRange.Find(xStr_PART, , xlValues, xlWhole, , , True)
    If Not xRg_PART Is Nothing Then
        xAddress_PART = xRg_PART.Address
        Do
            Set xRg_PART = ActiveSheet.UsedRange.FindNext(xRg_PART)
            If xRgUni_PART Is Nothing Then
                Set xRgUni_PART = xRg_PART
            Else
                Set xRgUni_PART = Application.Union(xRgUni_PART, xRg_PART)
            End If
        Loop While (Not xRg_PART Is Nothing) And (xRg_PART.Address <> xAddress_PART)
    End If
    'Application.CutCopyMode = False ' don't want an existing operation to interfere
    xRgUni_PART.EntireColumn.Activate
     With xRgUni_PART.EntireColumn
        .ColumnWidth = 30
        '.AutoFit
    .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
...
'Find Product_Category # column
    ...
    On Error Resume Next
    xStr_Product_Category = "SRProductCategory"
...
'Find Brand_Identifier
    ...
    On Error Resume Next
    xStr_Brand_Identifier = "BRANDIDENTIFIER"
...
'Find DC Date_Date
    Dim xRg_DC_Date As Range
    Dim xRgUni_DC_Date As Range
    Dim xAddress_DC_Date As String
    Dim xStr_DC_Date As String
    On Error Resume Next
    xStr_DC_Date = "Docket Date"
    Set xRg_DC_Date = ActiveSheet.UsedRange.Find(xStr_DC_Date, , xlValues, xlWhole, , , True)
    If Not xRg_DC_Date Is Nothing Then
        xAddress_DC_Date = xRg_DC_Date.Address
        Do
            Set xRg_DC_Date = ActiveSheet.UsedRange.FindNext(xRg_DC_Date)
            If xRgUni_DC_Date Is Nothing Then
                Set xRgUni_DC_Date = xRg_DC_Date
            Else
                Set xRgUni_DC_Date = Application.Union(xRgUni_DC_Date, xRg_DC_Date)
            End If
        Loop While (Not xRg_DC_Date Is Nothing) And (xRg_DC_Date.Address <> xAddress_DC_Date)
    End If
    'Application.CutCopyMode = False ' don't want an existing operation to interfere
    xRgUni_DC_Date.EntireColumn.Activate
     With xRgUni_DC_Date.EntireColumn
        .ColumnWidth = 11
        .HorizontalAlignment = xlCenter
        .VerticalAlignment = xlCenter
        .WrapText = True
